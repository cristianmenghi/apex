...
async function main() {
  ...
  if (args.length === 0 || args.includes("--help") || args.includes("-h")) {
    ...
    console.error("  This command runs an attack surface analysis that:");
    ...
    console.error("  # Basic attack surface analysis");
    console.error("  tsx scripts/attack-surface.ts --target example.com");
    console.error();
